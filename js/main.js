...
da.init();
const helloScreenArrow = document.querySelector('.hello-screen__arrow');
const helloScreen = document.querySelector('.hello-screen');
const page = document.querySelector('.page')
helloScreenArrow.addEventListener("click", function (e) {
	helloScreen.classList.add('close');
